...
/// <summary>
/// Class responsible for testing that the serialization of properties is tracked as Defined when case insensativity is enabled.
/// </summary>
[TestFixture]
public class CaseInsensitivePartialTests
{
    /// <summary>
    ...
    public CaseInsensitivePartialTests()
    {
    ...
    [Test]
    public void PartialModelAllCapsSerializesCorrectProperties()
    {
        // Arrange
        var inboundJson = """
            {
    ...
    [Test]
    public void PartialModelAllLowerSerializesCorrectProperties()
    {
        // Arrange
        var inboundJson = """
            {
